            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-white d-inline-block mb-0">Edit Category {{ $category->category_name }}</h6>
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input id="category-name" type="text" class="form-control" name="category_name" value="{{ $category->category_name }}" required autoFocus />
                                </div>
                            </div>
                        </div>
                    </div>
