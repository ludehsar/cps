...
function NavBar(props) {
  const { selectedTab, messages, classes, width, openAddBalanceDialog, isLoggedIn, userData, handleUserData, handleUserLogout } = props;
      ...
      <AppBar position="sticky" className={classes.appBar}>
        <Toolbar className={classes.appBarToolbar}>
          ...
          >
            ...
            >
              {(isWidthUp("sm", width) && isLoggedIn) && (
                <ListItemText
                  className={classes.username}
                  primary={
                    <Typography color="textPrimary">{userData.name}</Typography>
                  }
                />
              )}
            </ListItem>
