                            ...
                            <div className="card-body">
                                <form method="POST" action="#">
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-8">
                                            <input id="password" type="password" className="form-control" name="password" onChange={this.handleCurrentPasswordChange} required autoComplete="current-password" autoFocus />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-md-8">
                                            <input id="email" type="email" className="form-control" defaultValue={this.state.email} name="email" onChange={this.handleEmailChange} required autoComplete="email-address" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="form-group row mb-0">
                                        <div className="col-md-8 offset-md-3">
                                            <button type="submit" className="btn btn-default" disabled={!this.state.can_submit}>
                                                Save
                                            </button>
                                        </div>
                                    </div>
